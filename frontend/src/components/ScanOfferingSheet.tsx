...
const CATEGORY_LABELS: Record<string, string> = {
  MINISTERS_TITHE:"Ministers Tithe", TITHE:"Members Tithe",
  THANKSGIVING:"Thanksgiving", SUNDAY_LOVE_OFFERING:"Sunday Love Offering",
  CRM:"CRM Offering", GOSPEL_FUND:"Workers Offering", TRUST_FRUIT:"First Fruit",
  FIRST_BORN_REDEMPTION:"1st Born Redemption", SUNDAY_SCHOOL_OFFERING:"Sunday School Offering",
  SEED_FAITH_HOLY_COMMUNION:"Seed of Faith", JUNIOR_FELLOWSHIP:"Junior Fellowship",
