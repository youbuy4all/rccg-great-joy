    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-10 max-w-md w-full text-center">
        ...
        {process.env.NODE_ENV !== "production" && error?.message && (
          <pre className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-3 text-xs text-left text-red-600 dark:text-red-400 overflow-auto mb-6 max-h-32">
            {error.message}
          </pre>
        )}
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border border-gray-200 dark:border-gray-600 text-sm font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition"
          >
